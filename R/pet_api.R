...
PetApi <- R6::R6Class(
  ...
  public = list(
    ...
    FindPetsByStatusWithHttpInfo = function(status, ...){
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "array[Pet]", loadNamespace("rpetstore")),
          error = function(e){
    ...
    GetPetByIdWithHttpInfo = function(pet.id, ...){
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "Pet", loadNamespace("rpetstore")),
          error = function(e){
             stop("Failed to deserialize response")
          }
        )
    ...
    UploadFileWithHttpInfo = function(pet.id, additional.metadata=NULL, file=NULL, ...){
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "ModelApiResponse", loadNamespace("rpetstore")),
          error = function(e){
             stop("Failed to deserialize response")
          }
        )
