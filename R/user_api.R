...
UserApi <- R6::R6Class(
  ...
  public = list(
    ...
    GetUserByNameWithHttpInfo = function(username, ...){
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "User", loadNamespace("rpetstore")),
          error = function(e){
    ...
    LoginUserWithHttpInfo = function(username, password, ...){
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "character", loadNamespace("rpetstore")),
          error = function(e){
             stop("Failed to deserialize response")
          }
        )
